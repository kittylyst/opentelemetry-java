...
@ThreadSafe
public final class OtlpGrpcExecutionProfileExporter implements ExecutionProfileExporter {

  private final ThrottlingLogger logger =
      new ThrottlingLogger(Logger.getLogger(OtlpGrpcExecutionProfileExporter.class.getName()));
   ...
   */
  public static OtlpGrpcExecutionProfileExporterBuilder builder() {
    return new OtlpGrpcExecutionProfileExporterBuilder();
  }

  /**
   * Returns a new {@link OtlpGrpcExecutionProfileExporter} reading the configuration values from
   ...
   *
   * @return a new {@link OtlpGrpcExecutionProfileExporter} instance.
   */
  public static OtlpGrpcExecutionProfileExporter getDefault() {
