...
public final class OtlpGrpcExecutionProfileExporterBuilder {
   ...
   */
  public OtlpGrpcExecutionProfileExporterBuilder setChannel(ManagedChannel channel) {
   ...
   */
  public OtlpGrpcExecutionProfileExporterBuilder setTimeout(long timeout, TimeUnit unit) {
   ...
   * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
   */
  public OtlpGrpcExecutionProfileExporterBuilder setTimeout(Duration timeout) {
   ...
   */
  public OtlpGrpcExecutionProfileExporterBuilder setEndpoint(String endpoint) {
   ...
   * OtlpGrpcExecutionProfileExporterBuilder#endpoint} is set to build channel.
   *
   * @param key header key
   * @param value header value
   * @return this builder's instance
   */
  public OtlpGrpcExecutionProfileExporterBuilder addHeader(String key, String value) {
    if (metadata == null) {
   ...
   */
  public OtlpGrpcExecutionProfileExporter build() {
    if (channel == null) {
